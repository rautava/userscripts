...
if (menu2) {
	var myMenu = createMenuTable('Custom', false, menu2);
	createMenuLink(myMenu, 0, "Company.asp?action=ManageLocale&LocaleID=120091&CompanyID=2060", "Wanha Latino");
	createMenuLink(myMenu, 1, "Charts.asp?action=PaparazziList", "Paparazzi List");
	createMenuLink(myMenu, 2, "TourSettings.asp?action=Equipment", "Items in Tour Bus");
}
